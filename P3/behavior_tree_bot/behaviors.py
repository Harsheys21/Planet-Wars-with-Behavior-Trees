...
def spread_planet(state):
    ...
    my_planet = next(my_planets, None)
    target_planet = next(target_planets, None)

    if my_planet is None or target_planet is None:
        return False
